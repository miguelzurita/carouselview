...
public abstract class MxVideoPlayer extends FrameLayout implements MxMediaPlayerListener, View.OnClickListener,
    ...
    public void onCompletion() {
        ...
        if (userAction != null) {
            userAction.onActionEvent(UserAction.ON_AUTO_COMPLETE);
        }
    ...
    public void onAutoCompletion() {
        Log.i(TAG, "onAutoCompletion " + " [" + this.hashCode() + "] " + "===current listener size=" + MxVideoPlayerManager.mListenerList.size());
        mIsTryPlayOnError = false;
    ...
    public void setUserListener(UserAction userAction) {
